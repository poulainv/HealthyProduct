...
public class ListeIngredientCompleteAdapter extends ArrayAdapter<Ingredient> {
	...
	public ListeIngredientCompleteAdapter(Context c, int customRowView, List<Ingredient> list) {
