...
import com.hp.client.ScannerActivity;
...
public final class CaptureActivityHandler extends Handler {
  ...
  public CaptureActivityHandler(ScannerActivity scannerActivity,
    ...
    decodeThread = new DecodeThread(scannerActivity, decodeFormats, characterSet,
        new ViewfinderResultPointCallback(scannerActivity.getViewfinderView()));
    decodeThread.start();
    state = State.SUCCESS;
